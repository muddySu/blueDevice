...
//#define fileService     0x1803
//#define fileSub         0x2A06

#define fileService     0xFFF0
#define fileSub         0xFFF4
#define fileRead        0xFFF1
...
@property (nonatomic, weak) id <BTSmartSensorDelegate> delegate;       //delegate是一个id类型的对象
@property (strong, nonatomic) NSMutableArray *peripherals;
@property (strong, nonatomic) CBCentralManager *managerbluetooth;
